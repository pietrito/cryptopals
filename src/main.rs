...
fn main() -> Result<()> {
    ...
    let set1_chall3 = challenge3("1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736")?;
    println!("Answer of Set1 challenge3: {}", set1_chall3);

    let (line_number, line, key) = challenge4("data/set_1_challenge_4.txt")?;
    println!("Answer of Set1 challenge4: #{} - {} - Key: {}", line_number, line, key);
    println!("Decoded of Set1 challenge4: {}", challenge3(&line)?);

    let set1_chall5 = challenge5(&"Burning 'em, if you ain't quick and nimble
